 ...
 * Use the {@link GuestSendFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class GuestSendFragment extends Fragment {
    ...
    private ConstraintLayout haveacc,nothaveacc;
    private ArrayList<Notification> notifications;
    private RecyclerView rcv;
    private int selectop = 1;
    private Button btndel,btndelall,btnsearchname,btnsearchid;
    private FirebaseFirestore db;
    private TextView total;

    public GuestSendFragment() {
     ...
     * @return A new instance of fragment GuestSendFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static GuestSendFragment newInstance(String param1, String param2) {
        GuestSendFragment fragment = new GuestSendFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_guest_send, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        {
            haveacc.setVisibility(View.GONE);
            nothaveacc.setVisibility(View.VISIBLE);
        }
        else
        {
            haveacc.setVisibility(View.VISIBLE);
            nothaveacc.setVisibility(View.GONE);
            setRcv();
            setSearchView();
            setSearchOp();
            setBtndel();
    ...
    {
        haveacc = view.findViewById(R.id.fragguestsend_haveacc);
        nothaveacc= view.findViewById(R.id.fragguestsend_notlogin);
        notifications = new ArrayList<>();
        searchView = view.findViewById(R.id.fragguestsend_searchview);
        rcv = view.findViewById(R.id.fragguestsend_rcv);
        btndel = view.findViewById(R.id.fragguestsend_del);
        btndelall = view.findViewById(R.id.fragguestsend_delall);
        btnsearchid = view.findViewById(R.id.fragguestsend_searchid);
        btnsearchname = view.findViewById(R.id.fragguestsend_searchname);
        total = view.findViewById(R.id.fragguestsend_total);
    ...
    private void setRcv()
    {
        db.collection("Notification").
                whereEqualTo("receiver.id", MainActivity.user.getId())
