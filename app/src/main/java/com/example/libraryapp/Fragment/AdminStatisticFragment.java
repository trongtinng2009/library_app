...
public class AdminStatisticFragment extends Fragment {
    ...
    private LinearLayout layoutuser,layoutbook;
    ...
    {
        layoutbook = view.findViewById(R.id.fragadminsta_layoutbookoffline);
        layoutuser = view.findViewById(R.id.fragadminsta_layoutuser);
        layoutuser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.replace(R.id.adminact_fragmentcontainer,new AdminUserStaFragment());
        ...
        layoutbook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentTransaction transaction = AdminActivity.fragmentManager2.beginTransaction();
                transaction.replace(R.id.adminact_fragmentcontainer,new LibrarianStatisticFragment());
                transaction.addToBackStack(null);
                transaction.commit();
            }
        });
